...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('procesamiento_21_26.log'),
...
ENTIDADES = [f"{i:02d}" for i in range(21, 27)]  # 21 a 26
...
# CSV para tracking
CSV_OUTPUT = Path("./procesadas_21_26.csv")
...
def main():
    logger.info("="*60)
    logger.info("INICIANDO PROCESAMIENTO MASIVO - ENTIDADES 21 a 26")
    logger.info("="*60)
