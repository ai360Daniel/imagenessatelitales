"""
Procesamiento de Manzanas - Entidades 19 a 32
Este script procesa imágenes satelitales para todas las entidades desde 19 hasta 32.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('procesamiento_19_32.log'),
...
# Entidades a procesar (19 a 32)
ENTIDADES = [f"{i:02d}" for i in range(19, 33)]  # 19 a 32
...
# CSV para tracking
CSV_OUTPUT = Path("./procesadas_19_32.csv")
...
def main():
    logger.info("="*60)
    logger.info("INICIANDO PROCESAMIENTO MASIVO - ENTIDADES 19 a 32")
    logger.info("="*60)
