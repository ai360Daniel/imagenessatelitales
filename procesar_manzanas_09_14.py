"""
Procesamiento de Manzanas - Entidades 09 a 14
Este script procesa imágenes satelitales para todas las entidades desde 09 hasta 14.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('procesamiento_09_14.log'),
...
ENTIDADES = [f"{i:02d}" for i in range(9, 15)]  # 09 a 14
...
# CSV para tracking
CSV_OUTPUT = Path("./procesadas_09_14.csv")
...
def main():
    logger.info("="*60)
    logger.info("INICIANDO PROCESAMIENTO MASIVO - ENTIDADES 09 a 14")
    logger.info("="*60)
