"""
Procesamiento de Manzanas - Entidades 01 a 05
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('procesamiento_01_05.log'),
...
ENTIDADES = [f"{i:02d}" for i in range(1, 6)]  # 01 a 05
...
# CSV para tracking
CSV_OUTPUT = Path("./procesadas_01_05.csv")
...
def main():
    logger.info("="*60)
    logger.info("INICIANDO PROCESAMIENTO MASIVO - ENTIDADES 01 a 05")
    logger.info("="*60)
