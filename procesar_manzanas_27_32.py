"""
Procesamiento de Manzanas - Entidades 27 a 32
Este script procesa imágenes satelitales para todas las entidades desde 27 hasta 32.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('procesamiento_27_32.log'),
...
# CSV para tracking
CSV_OUTPUT = Path("./procesadas_27_32.csv")
...
def main():
    logger.info("="*60)
    logger.info("INICIANDO PROCESAMIENTO MASIVO - ENTIDADES 27 a 32")
    logger.info("="*60)
